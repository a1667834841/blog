...
<span class="orange">下面我会用两个业界使用比较成熟的注册中心开源实现，来讲解下应用内和应用外两种解决方案的不同之处。</span>
## 两种典型的注册中心实现
<strong>1. 应用内</strong>
采用应用内注册与发现的方式，最典型的案例要属 Netflix 开源的 Eureka，官方架构图如下。
![图片](https://static001.geekbang.org/resource/image/d2/1c/d220f8970c8d7a4f4ea4677ec2cbd61c.jpg)
...
![图片](https://static001.geekbang.org/resource/image/da/3f/da82d0cba1c49252e1ae48f91fcb543f.png)
...
![图片](https://static001.geekbang.org/resource/image/c0/ab/c0661d7687e29927fdcecc0f140fb5ab.png)
<strong>2. 数据一致性</strong>
