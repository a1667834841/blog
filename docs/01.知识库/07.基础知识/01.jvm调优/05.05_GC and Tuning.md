...
![image-20210406202126958](https://img.ggball.top/picGo/image-20210406202126958.png)

1. 拷贝算法 (copying) - 没有碎片，浪费空间

![image-20210406205541522](https://img.ggball.top/image-20210406205541522.png)

1. 标记压缩(mark compact) - 没有碎片，效率偏低（两遍扫描，指针需要调整）

   ![image-20210406205925070](https://img.ggball.top/image-20210406205925070.png)
...
3. 新生代 = Eden + 2个suvivor区 
   ...
   3. 再次YGC，eden + s1 -> s0
   4. 年龄足够 -> 老年代 （15 CMS 6） 年龄可以通过参数 —XX:MaxTenuringThreshlod 配置
   5. s区装不下 -> 老年代
