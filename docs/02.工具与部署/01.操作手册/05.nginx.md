...
![image-20210216151111903](https://img.ggball.top/image-20210216151111903.png)
...
![image-20210216151411155](https://img.ggball.top/image-20210216151411155.png)

2. 负载均衡

概念：单个服务器解 决不了，我们增加服务器的数量，然后将请求分发到各个服务器上，将原先请求集中到单个服务器上的情况改为将请求分发到多个服务器上，将负载分发到不同的服务器，也就是我们 所说的负载均衡。

![image-20210216152203076](https://img.ggball.top/image-20210216152203076.png)

3. 动静结合

为了加快网站的解析速度，可以把动态页面和静态页面由不同的服务器来解析，加快解析速 度。降低原来单个服务器的压力。

![image-20210216152325468](https://img.ggball.top/image-20210216152325468.png)
...
![image-20210216152720792](https://img.ggball.top/image-20210216152720792.png)
...
![image-20210218093015206](https://img.ggball.top/image-20210218093015206.png)
...
1. 首先保证 域名可以ping的通 ping ggball.top
   ...
   ![image-20210219152852636](https://img.ggball.top/image-20210219152852636.png)
